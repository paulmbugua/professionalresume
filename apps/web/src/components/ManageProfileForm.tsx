// /apps/web/src/components/ManageProfileForm.tsx
import React from 'react';
import { useManageProfileForm } from '@shared/hooks/useManageProfileForm';
import { toast } from 'react-toastify';

type PricingKeys = 'privateSession' | 'groupSession' | 'lecture' | 'workshop';
const pricingFields = ['privateSession', 'groupSession', 'lecture', 'workshop'] as const;
...
const ManageProfileForm = () => {
  ...
  // Define tokenRanges as a Record using the derived PricingKeys
            ...
            <div className="selected-recommendations space-y-2">
              ...
              {updatedData.recommended.length > 0 ? (
                updatedData.recommended.map((id: string) => {
                  ...
                  return (
                    prof && (
                      <div key={id} className="flex items-center justify-between bg-gray-900 p-2 rounded-lg hover:bg-gray-800">
