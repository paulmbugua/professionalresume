...
const TermsOfService: React.FC = () => (
  <div className="min-h-screen bg-gray-900 text-gray-200 p-6 flex flex-col">
    ...
    <h1 className="text-4xl font-bold text-white mb-6">
      DayBreak Tutors – Terms of Service
    </h1>
    ...
    <section className="space-y-6">
      ...
      <p>
        Welcome to DayBreak Tutors! These Terms of Service (“Terms”) govern your use of our website and mobile applications (collectively, the “Service”). By accessing or using the Service, you agree to be bound by these Terms.
      </p>
    </section>
    ...
    <section className="mt-6 space-y-4">
      ...
      <p>
        All session bookings occur through our platform. Students agree to pay the tutor’s stated fee plus any applicable taxes or platform fees. Payments are processed via our third-party payment provider; DayBreak Tutors does not store your payment details.
      </p>
    ...
    <section className="mt-6 space-y-4">
      ...
      <p>
        You retain ownership of any content you post (profiles, messages). By using the Service, you grant DayBreak Tutors a worldwide, royalty-free license to display and distribute that content in connection with the Service.
      </p>
    </section>
    ...
    <section className="mt-6 space-y-4">
      ...
      <p>
        The Service is provided “as is” and “as available.” To the fullest extent permitted by law, DayBreak Tutors disclaims all warranties, express or implied. We are not responsible for any damages arising from your use of the Service or any tutor-student interactions.
      </p>
    </section>
    ...
    <section className="mt-6 space-y-4">
      ...
      <p>
        You agree to indemnify and hold DayBreak Tutors and its affiliates harmless from any claim, loss, or liability arising out of your violation of these Terms or your use of the Service.
      </p>
    </section>
    ...
    <section className="mt-6 mb-12 space-y-4">
      ...
      <p>
        ...
        <a href="mailto:support@DayBreak.com" className="text-pink-400 hover:underline">
          support@DayBreak.com
        </a>.
      </p>
    </section>
  </div>
