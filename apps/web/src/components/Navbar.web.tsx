      ...
      <div className="flex items-center md:hidden mb-2">
        ...
        <div className="flex items-center space-x-3.5">
          <Link to="/messages" className="relative hover:text-softPink">
            <FontAwesomeIcon icon={faEnvelope as IconProp} className="h-6 w-6" />
          ...
          >
            <FontAwesomeIcon icon={faCog as IconProp} className="h-6 w-6" />
            {showAlert && (
              <span className="absolute top-0 right-0 bg-red-600 text-white text-xs rounded-full px-1">
                !
              </span>
      ...
      <div className="hidden md:flex items-center justify-between">
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link to="/buy-tokens" className="flex flex-col items-center hover:text-softPink">
            <FontAwesomeIcon icon={faCoins as IconProp} className="h-5 w-5" />
