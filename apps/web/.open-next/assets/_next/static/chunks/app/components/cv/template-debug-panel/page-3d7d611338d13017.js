...
</script>`;return t.replace("</body>",`${i}</body>`)},[e]);return(0,s.useEffect)(()=>{let e=e=>{let t=e.data;if(!t||!0!==t.__cv_iframe_resize)return;let a=Number(t.height);Number.isFinite(a)&&!(a<=0)&&i(Math.min(Math.max(a+24,900),5e3))};return window.addEventListener("message",e),()=>window.removeEventListener("message",e)},[]),(0,a.jsx)("div",{className:"w-full",children:(0,a.jsx)("iframe",{title:"ATS Minimal",className:"w-full rounded-xl border border-gray-200 bg-white",sandbox:"allow-same-origin",scrolling:"no",srcDoc:r,style:{height:t,width:"100%",border:0}})})}},72679:(e,t,i)=>{"use strict";i.d(t,{default:()=>a}),i(95155),i(12115),i(41463);let a=({draft:e,templateCount:t,templateSource:i,resumeSource:a,apiError:s})=>null},94258:(e,t,i)=>{"use strict";i.d(t,{L:()=>o,Y:()=>l});let a=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,s=/\son\w+="[^"]*"/gi,r=/\son\w+='[^']*'/gi,n=/\son\w+=([^\s>]+)/gi;function o(e){return e.replace(a,"").replace(s,"").replace(r,"").replace(n,"")}function l(e,t){}}},e=>{e.O(0,[8441,3794,7358],()=>e(e.s=368)),_N_E=e.O()}]);