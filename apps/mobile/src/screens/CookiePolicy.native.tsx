...
const CookiePolicyNative: React.FC = () => {
  return (
    ...
    >
      <Text className="text-3xl font-bold text-plum mb-6">Cookie Policy for FunzaSasa</Text>
      <Text className="text-sm text-gray-500 mb-8">Effective Date: 01-02-2025</Text>

      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">1. Introduction</Text>
      ...
      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">2. What Are Cookies?</Text>
        <Text className="text-base text-gray-800 leading-relaxed">
      ...
      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">3. How We Use Cookies</Text>
        <Text className="text-base text-gray-800 leading-relaxed mb-4">We use cookies to:</Text>
        <View className="ml-4">
      ...
      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">5. Third-Party Cookies</Text>
        ...
        <View className="ml-4">
          <Text className="text-base text-gray-800">• [List of Third-Party Providers]</Text>
        </View>
      </View>

      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">6. Managing Cookies</Text>
        <Text className="text-base text-gray-800 leading-relaxed">
      ...
      <View className="mb-8">
        <Text className="text-2xl font-semibold text-blue-500 mb-4">7. Changes to This Policy</Text>
        <Text className="text-base text-gray-800 leading-relaxed">
      ...
      <View>
        <Text className="text-2xl font-semibold text-blue-500 mb-4">8. Contact Us</Text>
        <Text className="text-base text-gray-800 leading-relaxed">
          If you have any questions about our use of cookies, please contact us at:
        </Text>
        <Text className="text-base text-gray-800 mt-2">+254 720 423 764</Text>
      </View>
    </ScrollView>
  );
};
