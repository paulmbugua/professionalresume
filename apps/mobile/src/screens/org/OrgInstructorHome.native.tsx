      ...
      >
        ...
        <View style={tw`px-4`}>
          ...
          >
            ...
            <View
              style={[
                tw`mt-3 h-2 rounded-full overflow-hidden`,
                { backgroundColor: palette.divider },
              ]}
            >
              <View
          ...
          >
            ...
            >
              Enter a courseId to generate a magic link that drops
              learners straight into RobotTeacher for this course.
            </Text>
            ...
            <TouchableOpacity
              ...
              style={[
                tw`mt-3 h-10 px-4 rounded-2xl items-center justify-center`,
                { backgroundColor: '#059669' },
              ]}
            >
              <Text
            ...
            {!!inviteUrl && (
              <>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    tw`mt-2 px-3 py-2 rounded-2xl self-start`,
                    { backgroundColor: '#4f46e5' },
                  ]}
                >
                  <Text
