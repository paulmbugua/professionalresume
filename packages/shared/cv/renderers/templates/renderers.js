...
export function renderProjectForwardHtml(draft = {}) {
  ...
  return doc(
    d,
    `<main class="page projectForwardLayout"><header><div><div class="project-mark" aria-hidden="true"><span></span><span></span><span></span></div><h1>${esc(d.basics.name || 'Your Name')}</h1><p class="headline">${esc(d.basics.headline || '')}</p></div><p class="contact">${contactLine(d.basics)}</p></header><section class="content">${sections}</section></main>`,
    `${TYPOGRAPHY_BASE}body{background:#eef2ff;font-family:var(--fontFamily);color:var(--textColor)}.projectForwardLayout{padding:0}.projectForwardLayout header{display:grid;grid-template-columns:1fr 70mm;gap:8mm;padding:11mm 12mm;background:#f8fafc;border-bottom:4px solid var(--accent)}.project-mark{display:flex;gap:1.8mm;margin:0 0 4mm}.project-mark span{display:block;height:3mm;width:10mm;border-radius:999px;background:var(--accent)}.project-mark span:nth-child(2){width:6mm;opacity:.65}.project-mark span:nth-child(3){width:3mm;opacity:.35}.headline{margin:3px 0 0;color:var(--mutedTextColor);font-size:var(--resolvedHeadlineSize)}.contact{text-align:right;color:var(--mutedTextColor);font-size:var(--resolvedMetaSize);margin:0}.content{padding:9mm 12mm 12mm}.content h2{color:var(--primary);border-left:4px solid var(--accent);padding-left:6px;margin:0 0 5px;letter-spacing:.12em}.content section:nth-of-type(2){background:#f8fafc;border:1px solid #dbe3ee;padding:5mm;margin-bottom:6mm}ul{margin:4px 0 0;padding-left:17px}.item{break-inside:auto;page-break-inside:auto}`
  );
}
